...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Bale Barcode", "fieldname": "bale_barcode", "fieldtype": "Data", "width": 80},       
    ...
    data = frappe.db.sql(
        ...
        SELECT
            ...
            cd.purchase_weight AS purchase_kgs,
            cd.reweight AS reweight_kgs,
            cd.gain_loss AS loss_kgs
